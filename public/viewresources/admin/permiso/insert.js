...
function registrarPermiso() {
    const formData = $('#frmPermisoInsert').serialize();
...
function agregarFilaTabla(permiso) {
    ...
    const nuevaFila = `
        <tr id="permisoRow${permiso.id_permiso}">
            ...
            <td class="text-center">
                ${requiereRecupero ? 
                    '<span class="badge badge-warning"><i class="fas fa-check-circle"></i> Sí</span>' : 
                    '<span class="badge badge-secondary"><i class="fas fa-times-circle"></i> No</span>'}
            </td>
            <td class="text-center">
