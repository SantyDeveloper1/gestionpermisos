...
<section class="content">
    <div class="container-fluid">
        <form id="userProfileForm" action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="document_type" class="form-control">
                                            ...
                                            <option value="CE" {{ $user->document_type == 'CE' ? 'selected' : '' }}>Carné de Extranjería</option>
                                        </select>
                                    </div>
...
@section('js')
<script src="{{ asset('viewresources/admin/profile/profile_update.js') }}"></script>
@endsection