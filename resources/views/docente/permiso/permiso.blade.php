...
@section('js')
    <script src="{{ asset('viewresources/docente/permiso/insert.js?v=' . time()) }}"></script>
    <script src="{{ asset('viewresources/docente/permiso/detalle.js?v=' . time()) }}"></script>
    <script src="{{ asset('viewresources/docente/permiso/update.js?v=' . time()) }}"></script>
    <script src="{{ asset('viewresources/docente/permiso/delete.js?v=' . time()) }}"></script>
