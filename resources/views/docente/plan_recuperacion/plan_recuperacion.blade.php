                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ url('docente/sesion_recuperacion?plan_id=' . $plan->id_plan) }}"
...
@section('js')
    <script src="{{ asset('viewresources/docente/plan_recuperacion/insert.js?v=' . time()) }}"></script>
    <script src="{{ asset('viewresources/docente/plan_recuperacion/update.js?v=' . time()) }}"></script>
    <script src="{{ asset('viewresources/docente/plan_recuperacion/delete.js?v=' . time()) }}"></script>
    ...
    <script src="{{ asset('viewresources/docente/plan_recuperacion/aprobar.js?v=' . time()) }}"></script>
@endsection