                ...
                <div class="card-body">
                    ...
                    @if(auth()->user()->docente)
                        <div class="info-item">
                            ...
                            <span
                                class="info-value badge-code">{{ auth()->user()->docente->codigo_unamba ?? 'No asignado' }}</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">
                                <i class="fas fa-book"></i> Tipo Contrato:
                            </span>
                            <span class="info-value">{{ auth()->user()->docente->contrato->nombre ?? 'No asignado' }}</span>
                        </div>
                    @else
                        <div class="info-item">
                            <span class="info-label">
            ...
            <div class="info-card status-card">
                ...
                <div class="card-body">
                    ...
                    <div class="session-info">
                        ...
                        <p><i class="fas fa-clock"></i> Último acceso: {{ now()->format('d/m/Y H:i') }}</p>
                    </div>
                </div>
            </div>
        </div>
